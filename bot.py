...
async def start_command(message:Message):
    ...
    try:
        ...
        await message.answer(text="Assalomu alaykum, botimizga xush kelibsiz!\nBotimiz orqali siz valyuta narxlarini bilib olishingiz mumkin!\n Valyutalar narxi - /currency")
    except:
        await message.answer(text="Assalomu alaykum! Valyuta tanlang!")
